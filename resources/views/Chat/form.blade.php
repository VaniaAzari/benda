	...
	<section class="content">
		<div class="row ">
			<div class="col-12">
				...
				@endif				
				<form class="form-horizontal" method="POST" action="/chat/{{ $action }}{{($action!='simpan')? '/'.$chat['id'] : ''}}" enctype="multipart/form-data">
					{{ csrf_field() }}
					<div class="modal-header">
						<h3>Form Tambah Forum</h3>
					</div>
					<div class="modal-body">
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<textarea name="topik" style="width: 753px; height: 140px;" value="{{ ($action!='simpan') ? $chat['topik'] : '' }}"></textarea>
							</div>
						</div>		
						<div class="form-group">
