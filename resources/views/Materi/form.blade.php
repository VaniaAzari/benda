	...
	<section class="content">
		<div class="row ">
			<div class="col-12">
				...
				@endif
				<form class="form-horizontal" method="POST" action="{{action('MateriController@simpan',  ['matakuliah_id' => $matakuliah_id,'kelas_id' => $kelas_id,'angkatan_id' => $angkatan_id])}}" enctype="multipart/form-data">
					{{ csrf_field() }}					
					<h4 class="page-head-line">Form Tambah Materi</h4>					
					<div class="modal-body">
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<input type="text" class="form-control" name="file_title" placeholder="Judul" value="{{ ($action!='simpan') ? $materi['file_title'] : '' }}">
								...
								<input type="hidden" class="form-control" name="dosen_id"  value="{{$value['dosen_id']}}">
							</div>
						</div>								
						<div class="form-group">
