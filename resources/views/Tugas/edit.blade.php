...
@section('content')
	<section class="content">
		<div class="row ">
			<div class="col-12">
				<form class="form-horizontal" method="POST" action="/tugas/{{ $action }}{{($action!='edit')? '/'.$tugas['id'] : ''}}{{($action!='edit')? '/'.$tugas['matakuliah_id'] : ''}}{{($action!='edit')? '/'.$tugas['kelas_id'] : ''}}{{($action!='edit')? '/'.$tugas['angkatan_id'] : ''}}" enctype="multipart/form-data">
					{{ csrf_field() }}					
						<h4 class="page-head-line">Form Edit Tugas</h4>					
