		 ...
		 <div class="row">
            ...
            <div class="col-md-3 col-sm-3 col-xs-6">
                    <div class="dashboard-div-wrapper bk-clr-two" style="height: 134px;width: 230px;">
                        ...
                        <h5> <a href="{{ URL::to('/bahanajar') }}"><font color="#fffff">Matakuliah</font></a> </h5>
             ...
             <div class="col-md-3 col-sm-3 col-xs-6">
                   <div class="dashboard-div-wrapper bk-clr-two" style="height: 134px;width: 230px;">
                        ...
                        <h1><b>{{ $hitungmateri }}</b></h1></div>
                         <h5><a href="{{ URL::to('/bahanajar') }}"> <font color="#fffff">Materi</font> </a></h5>
                    </div>
                </div>
                 <div class="col-md-3 col-sm-3 col-xs-6">
                  <div class="dashboard-div-wrapper bk-clr-two" style="height: 134px;width: 230px;">
                         ...
                         <h1><b>{{ $hitungtugas }}</b></h1></div>
                             <h5> <a href="{{ URL::to('/bahanajartugas') }}"><font color="#fffff">Tugas</font></a> </h5>
                    </div>
                </div>
                <div class="col-md-3 col-sm-3 col-xs-6">
                     <div class="dashboard-div-wrapper bk-clr-two" style="height: 134px;width: 230px;">
                         ...
                         <h5> <a href="{{ route('kuis.mahasiswa') }}"><font color="#fffff">Kuis</font></a> </h5>
                    </div>
                </div>
                <br><br><br><br><br><br>
                     ...
                     <div class="row">
                        ...
                        <div class="col-md-6">
                         <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                   <span class="glyphicon glyphicon-comment  text-warning" ></span> &nbsp;  <a href="{{ URL::to('/chatmhs') }}">Forum </a>
