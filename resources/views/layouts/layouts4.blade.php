...
<body>
    <header>
        <div class="container">   
         <div class="btn-group">
               <a href="{{url('/helpmahasiswa')}}" class="btn btn-md btn-primary" >Bantuan</a>
            </div>         
             <div class="btn-group">
                     <button data-toggle="dropdown" class="btn btn-primary dropdown-toggle"> <span class="glyphicon glyphicon-user"></span>&nbsp; {{ Auth::guard('mahasiswa')->user()->nama }} <span class="caret"></span></button>
                ...
                <div class="col-md-12">
                    <div class="navbar-collapse collapse ">
                        <ul id="menu-top" class="nav navbar-nav navbar-right">
                            <li><a href="{{ URL::to('/homemahasiswa') }}">Beranda</a></li>                        
                            <li><a href="{{ URL::to('/bahanajar') }}">Matakuliah</a></li>
                            <li><a href="{{ URL::to('/bahanajartugas') }}">Tugas</a></li>
                            <!-- <li><a href="{{ route('kuis.mahasiswa') }}">Kuis</a></li> -->
                            <li>
                            <a data-toggle="dropdown" href"{{  route('kuis.mahasiswa') }}">
                                Kuis <span class="caret"></span>
                            </a>
                                <ul class="dropdown-menu" style="background: #337ab7;">
                                    <li><a href="{{  route('kuis.mahasiswa')  }}">Kuis Pilihan Ganda</a></li>
                                    <li><a href="{{ route('kuisessay.mahasiswa')  }}" >Kuis Essay </a></li>
                                </ul>
                            </li> 
                             <!-- <li><a href="{{ URL::to('logActivity3') }}">Log History</a></li>    -->     
                        </ul>
                    </div>
                </div>
            </div>
