		...
		<div class="col-12">
			<div class="panel panel-default">
				...
				<div class="panel-heading text-right">
					<a href="/matakuliah/create" class="btn btn-md btn-info" ><i class="fa fa-plus"></i>&nbsp;Tambah Data</a>
                          {{ csrf_field() }}
				</div> 		
        ...
        $('table#dataTable tbody').on( 'click', 'td>a', function (e) {
            ...
            if($(this).hasClass('delete')) {
                swal({
                    ...
                    value == 'execute' ? deleteData(data.id, $('input[name="_token"]').val(), "{{ route('matakuliah.delete') }}")
                    : null
                });
                
            }else if($(this).hasClass('edit')) {
                $('#id_edit').val(data.id);
                $('#nama_edit').val(data.nama_matkul);              
